...
class Toc0318:
    ...
    def read_toc0318(file, offset):
        ...
        for part_index, part in enumerate(parts):
            part_type, end_offset, size, value1, name, value2, part_offsets = part
            for part_bit_offset in part_offsets:
                file.seek(part_bit_offset, os.SEEK_SET)
                if Toc0318.PRINT_DEBUG:
                    print(f"Reading part[{part_index}] ({name}) from: {file.tell()}")
                ...
                flags_4len = [0x2E, 0x03, 0x0F, 0x54, 0x56, 0xBB, 0x55, 0xF2, 0x75, 0x41, 0x15, 0x8D, 0x5B, 0x7C, 0x58, 0xF5, 0xF8, 0xF6, 0x1A]
                flags_8len = [0x2A, 0x2B, 0x26, 0x01, 0x02, 0x2F, 0xC4, 0x43, 0x25, 0x72, 0x0B, 0x06, 0x1F, 0xFF, 0xF4, 0xF9, 0x6F]
                flags_12len = [0xFD, 0x0E, 0x2C, 0x73, 0x0C, 0x17, 0x51, 0x4C, 0x08, 0x05, 0x04, 0x5E, 0x14, 0x12, 0x09, 0x53]
                ...
                if flag in text_flags:
                    ...
                    for t in range(len(text_data)):
                        ...
                        if int_value & 0xA0 == 0xA0 and int_value < 0xFF:
