...
class MpcEntry(GameEntry):

    def __init__(self, model: MPCModel, folder, path, game_version: GameVersion, game_variant: str, record: DirectoryRecord, subtype: bytes, subfile_index, entry_position):
    ...
    def get_file_name(self) -> str:
        ...
        return f"[{self.subfile_index}] MPC"
    ...
    def extract(self, iso, options, destination) -> bool:
        ...
        with open(f"{destination}/mpc-{self.get_file_name()}.obj", "w") as file:
